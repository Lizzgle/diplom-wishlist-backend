    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Friend1Id = table.Column<string>(type: "text", nullable: false),
                    Friend2Id = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_friendship_users_Friend1Id",
                        column: x => x.Friend1Id,
                        principalTable: "users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_friendship_users_Friend2Id",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "45a89411-4ca2-4a3f-a3f4-3c764f4d1904", null, "admin", "ADMIN", null },
                    { "b8f1d6a9-b055-4085-90aa-d785ccdd2913", null, "user", "USER", null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_friendship_Friend1Id_Friend2Id",
                table: "friendship",
